...
!- S  = SID base address
!- P  = Points (score)
3 C=55548:W=13:H=7:T=9:F=4:L=4:N=1:G=1:S=54272:P=.
...
5 GETk$:IFk$="w"ANDDX<>.THENDY=-40:DX=.
6 IFk$="s"ANDDX<>.THENDY=40:DX=.
7 IFk$="a"ANDDY<>.THENDY=.:DX=-1
8 IFk$="d"ANDDY<>.THENDY=.:DX=1
...
101 FORD=0TO49:NEXT:NEXT
199 STOP

!- Blank screen, draw, return.
980 POKE53265,PEEK(53265)AND239
981 ?,"{right}{right}{right}{reverse on}{pink}{169}{reverse off}{yellow}{169}{right}{reverse on}{127}{right}{right}{cyan}{169}{light gray}{127}{right}{pink} {reverse off}{169}{right}{reverse on}{yellow} F":?,"{right}{right}{right}{reverse on}{cyan}{169}{reverse off}{purple}{169}{right}{reverse on}{yellow} {light green}{127}{right}{cyan} {light gray} {right}{purple} {127}{right}{light green} {cyan}E"
982 ?"{right}{white}UC{light green}F{yellow}F{cyan}R{green}FF{light blue}CI":?"{right}{light green}B{right}{right}{right}{right}{right}{right}{right}{light blue}B"
983 ?"{right}{yellow}H {light green}s{yellow}c{cyan}W{yellow}r{light green}e {blue}G {white}U{light green}C{yellow}F{cyan}F{pink}F{orange}R{red}RRRRRRRFF{orange}F{pink}C{yellow}I"
984 ?"{right}{cyan}H{right}{right}{right}{right}{right}{right}{right}{blue}G{right}{light green}B",,"{left}{left}{yellow}B":?"{right}{green}H{right}{right}{right}{right}{right}{right}{right}{blue}G{right}{yellow}H",,"{left}{left}{pink}G"
985 ?"{right}{green}B{right}{right}{right}{right}{right}{right}{right}{light blue}B{right}{cyan}H",,"{left}{left}{orange}G":?"{right}{light blue}JCD{blue}DED{light blue}DC{green}K{right}{pink}H",,"{left}{left}{red}G"
986 ?,"{right}{orange}Y",,"{left}{left}{red}T":FORI=.TO5:?,"{right}Y",,"{left}{left}T":NEXT
987 ?,"{right}Y",,"{left}{left}{orange}T":?,"{right}{red}H",,"{left}{left}{pink}G":?,"{right}{orange}H",,"{left}{left}{cyan}G"
988 ?,"{right}{pink}H",,"{left}{left}{yellow}G":?,"{right}B",,"{left}{left}{light green}B":?,"{right}{yellow}J{pink}C{orange}D{red}DDEEEEEEE{orange}E{pink}D{cyan}D{yellow}D{light green}C{white}K"
989 ?"{home}{down}{down}{down}{down}{down}{black}":FORI=.TO15:?,"{right}{right}QQQQQQQQQQQQQQQQ":NEXT:?"{white}"
990 RETURN
